...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2021 at 07:01 PM
...
(3, '::1', 'arto@gmail.com', 1620973930),
(4, '::1', 'admin@gmail.com', 1620973940),
(5, '::1', 'admin@admin.com', 1626416081),
(6, '::1', 'admin@gmail.com', 1626416091);
...
(163, 12334563, 'Mahasiswa 2', 2, 2, 1, 'mahasiswa2@gmail.com', '097677556754');
...
(12, 'NOFA EKASARI A.Md', 'PT TELKOM', 2, '1e72575939187c40a6d605d2e1711130.png');
...
(81, 127, 12334563, 1, '2021-04-20', '11:17:41', 2),
(82, 1, 12345678, 1, '2021-05-14', '01:12:20', 2),
(83, 127, 12334563, 1, '2021-05-14', '01:12:31', 2);
...
(2, 'Buka Bersama', '2021-05-20', '6745de56e9fe2a29e7a270664ce4a2fa.jpg');
...
(7, 'TOKOPEDIA', '2d98ce4df51005974a0ad8e4a6833710.png', 2);
...
(5, 2, 200000, 200, '8b74d60597fc566765d6544c0eebc179.JPG');
...
(1, '127.0.0.1', 'administrator', '$2y$12$ml83HGMMj9/8lQ9yTVmhrO/jIQiGPEwvn0cIXYRP2W3fIaUHeo7G.', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1620973954, 1, 'Admin', 'istrator', 'ADMIN', '0');
...
--
ALTER TABLE `pendaftaran_seminar`
  MODIFY `id_pendaftaran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT for table `presensi_seminar`
--
ALTER TABLE `presensi_seminar`
  MODIFY `id_presensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
